...
namespace DMS_ii
{
    public partial class init_index : Form 
    {
        ...
        FileManager FMer = null;


        public init_index(FileManager iit)
        {
            InitializeComponent();
            FMer = iit;
        ...
        {
            FMer.DMS_Service_ENVtoolStripStatusLabel.Text = "QAS";            
        }

        private void System_DEVStartup_button_Click(object sender, EventArgs e)
        {
            FMer.DMS_Service_ENVtoolStripStatusLabel.Text = "DEV";
        }

        private void System_PRDStartup_button_Click(object sender, EventArgs e)
        {
            FMer.DMS_Service_ENVtoolStripStatusLabel.Text = "PRD";
        }
